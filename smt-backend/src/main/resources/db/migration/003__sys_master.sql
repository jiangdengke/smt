...
(
    ...
    CONSTRAINT [UQ_sys_workshop_id_factory] UNIQUE ([id], [factory_id])
);
...
(
    ...
    CONSTRAINT [UQ_sys_line_id_workshop] UNIQUE ([id], [workshop_id])
);
...
(
    ...
    CONSTRAINT [UQ_sys_machine_id_model] UNIQUE ([id], [model_id])
);
...
(
    ...
    CONSTRAINT [UQ_sys_abnormal_type_id_category] UNIQUE ([id], [abnormal_category_id])
);
...
(
    ...
    CONSTRAINT [UQ_sys_person_id_team] UNIQUE ([id], [team_id])
);
